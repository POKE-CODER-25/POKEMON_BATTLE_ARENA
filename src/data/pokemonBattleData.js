...
const pokemon = ({
  ...
  hasTrait,
  traitName:
    traits.length > 1 ? 'Multiple Traits' : (traits[0]?.name ?? null),
...
export const fanFavouriteAPokemon = [
  pokemon({
    id: 448,
    name: 'Lucario',
    category: POKEMON_CATEGORIES.FAN_FAVOURITE,
    draftGroup: 'FAN_FAVOURITE_A',
    score: 88,
    types: ['Fighting', 'Steel'],
    priority: PRIORITY.lucario,
    traitEffects: ['Lucario gains permanent +2 battle points'],
    specialRules: [
      'Aura points cannot be stolen, reduced, absorbed, transferred, or changed by lower-priority traits',
    ],
    traits: [
      trait(
        'Aura Master',
        'Lucario gains permanent +2 battle points. Aura points cannot be stolen, reduced, absorbed, transferred, or changed by lower-priority traits.',
        PRIORITY.lucario,
        ['Lucario gains permanent +2 battle points'],
        [
          'Aura points cannot be stolen, reduced, absorbed, transferred, or changed by lower-priority traits',
        ],
      ),
  ...
  pokemon({
    ...
    types: ['Ghost', 'Poison'],
    priority: PRIORITY.normal,
    traitEffects: ['Steals 3 trait points from the opponent when applicable'],
    traits: [
      trait(
        'Shadow Trickster',
        'Steals 3 trait points from the opponent when applicable.',
        PRIORITY.normal,
        ['Steals 3 trait points from the opponent when applicable'],
      ),
    ],
  ...
  pokemon({
    ...
    priority: PRIORITY.normal,
    traitEffects: [
      "If Gardevoir's score is lower than the opponent's score, Gardevoir gains +4",
    ],
    traits: [
      trait(
        'Devotion',
  ...
  pokemon({
    ...
    types: ['Dragon'],
    priority: PRIORITY.normal,
    traitEffects: ['Gains +5 against Dragon-type Pokemon'],
    traits: [
      trait(
        'Dragon Slayer',
        'Gains +5 against Dragon-type Pokemon.',
        PRIORITY.normal,
        ['Gains +5 against Dragon-type Pokemon'],
      ),
    ],
  ...
  pokemon({
    ...
    types: ['Flying', 'Dragon'],
    priority: PRIORITY.normal,
    traitEffects: ['Opponent loses 3 trait bonus points'],
    traits: [
      trait(
        'Sonic Wave',
        'Opponent loses 3 trait bonus points.',
        PRIORITY.normal,
        ['Opponent loses 3 trait bonus points'],
      ),
    ],
  ...
  pokemon({
    ...
    types: ['Ground', 'Dragon'],
    priority: PRIORITY.normal,
    traitEffects: ['Type disadvantages against Flygon are reduced by 3'],
    traits: [
      trait(
        'Desert Spirit',
        'Type disadvantages against Flygon are reduced by 3.',
        PRIORITY.normal,
        ['Type disadvantages against Flygon are reduced by 3'],
      ),
    ],
  ...
  pokemon({
    ...
    types: ['Water', 'Flying'],
    priority: PRIORITY.normal,
    traitEffects: ['Opponent loses 3 score'],
    traits: [
      trait(
        'Intimidate',
        'Opponent loses 3 score.',
        PRIORITY.normal,
        ['Opponent loses 3 score'],
      ),
    ],
  ...
  pokemon({
    ...
    types: ['Steel', 'Ground'],
    priority: PRIORITY.normal,
    traitEffects: ['Opponent type bonus cannot exceed +3'],
    traits: [
      trait(
        'Iron Fortress',
        'Opponent type bonus cannot exceed +3.',
        PRIORITY.normal,
        ['Opponent type bonus cannot exceed +3'],
      ),
    ],
  ...
  pokemon({
    ...
    types: ['Dark'],
    priority: PRIORITY.normal,
    traitEffects: ['Copies opponent type bonus'],
    traits: [
      trait(
        'Illusion',
        'Copies opponent type bonus.',
        PRIORITY.normal,
        ['Copies opponent type bonus'],
      ),
    ],
  ...
  pokemon({
    ...
    priority: PRIORITY.normal,
    traitEffects: [
      'If score difference is 3 points or less, Gallade gains +3',
    ],
    traits: [
      trait(
        'Noble Duelist',
  ...
  pokemon({
    ...
    priority: PRIORITY.normal,
    traitEffects: [
      'If opponent is ahead by 1 to 3 points, Scizor gains +4',
    ],
    traits: [
      trait(
        'Bullet Punch',
  ...
  pokemon({
    ...
    priority: PRIORITY.protected,
    traitEffects: [
      'Normal rounds: 10% chance to gain +20 battle points',
      'Master Round: 10% chance to gain +25 battle points',
    ],
    specialRules: [
      'Awakening is protected and cannot be disabled, stolen, reduced, absorbed, or transferred',
      'If awakened in Master Round, Snorlax reaches 105',
      'If Snorlax exists in a player team, Snorlax automatically occupies one of the three Master Round selection slots',
      'Use Gigantamax Snorlax form art later during polish',
    ],
    traits: [
      trait(
        'Sleeping Monster',
        'Normal rounds: 10% chance to gain +20 battle points. Master Round: 10% chance to gain +25 battle points. If awakened in Master Round, Snorlax reaches 105.',
        PRIORITY.protected,
        [
          'Normal rounds: 10% chance to gain +20 battle points',
          'Master Round: 10% chance to gain +25 battle points',
  ...
  pokemon({
    ...
    types: ['Water', 'Ice'],
    priority: PRIORITY.normal,
    traitEffects: ['If Lapras loses, the next ally gains +2'],
    traits: [
      trait(
        'Ocean Guardian',
        'If Lapras loses, the next ally gains +2.',
        PRIORITY.normal,
        ['If Lapras loses, the next ally gains +2'],
      ),
    ],
  ...
  pokemon({
    ...
    types: ['Dragon'],
    priority: PRIORITY.normal,
    traitEffects: ['Opponent trait bonus is reduced by 2'],
    traits: [
      trait(
        'Gooey Armor',
        'Opponent trait bonus is reduced by 2.',
        PRIORITY.normal,
        ['Opponent trait bonus is reduced by 2'],
      ),
    ],
  ...
  pokemon({
    ...
    types: ['Normal', 'Flying'],
    priority: PRIORITY.normal,
    traitEffects: ['If opponent score is higher, Staraptor gains +4'],
    traits: [
      trait(
        'Reckless',
        'If opponent score is higher, Staraptor gains +4.',
        PRIORITY.normal,
        ['If opponent score is higher, Staraptor gains +4'],
      ),
    ],
  ...
  pokemon({
    ...
    priority: PRIORITY.normal,
    traitEffects: [
      'If Talonflame has type advantage, it gains an additional +2',
    ],
    traits: [
      trait(
        'Gale Wings',
...
const fanFavouriteB = (id, name, score, types) =>
  pokemon({
    id,
    name,
    category: POKEMON_CATEGORIES.FAN_FAVOURITE,
    draftGroup: 'FAN_FAVOURITE_B',
    score,
    types,
    hasTrait: false,
...
export const fanFavouriteBPokemon = [
  fanFavouriteB(59, 'Arcanine', 83, ['Fire']),
  fanFavouriteB(38, 'Ninetales', 83, ['Fire']),
  fanFavouriteB(778, 'Mimikyu', 83, ['Ghost', 'Fairy']),
  fanFavouriteB(637, 'Volcarona', 82, ['Bug', 'Fire']),
  fanFavouriteB(701, 'Hawlucha', 82, ['Fighting', 'Flying']),
  fanFavouriteB(681, 'Aegislash', 82, ['Steel', 'Ghost']),
  fanFavouriteB(68, 'Machamp', 82, ['Fighting']),
  fanFavouriteB(65, 'Alakazam', 81, ['Psychic']),
  fanFavouriteB(34, 'Nidoking', 81, ['Poison', 'Ground']),
  fanFavouriteB(31, 'Nidoqueen', 80, ['Poison', 'Ground']),
  fanFavouriteB(214, 'Heracross', 80, ['Bug', 'Fighting']),
  fanFavouriteB(230, 'Kingdra', 80, ['Water', 'Dragon']),
  fanFavouriteB(359, 'Absol', 79, ['Dark']),
  fanFavouriteB(306, 'Aggron', 79, ['Steel', 'Rock']),
  fanFavouriteB(405, 'Luxray', 78, ['Electric']),
  fanFavouriteB(466, 'Electivire', 78, ['Electric']),
  fanFavouriteB(467, 'Magmortar', 77, ['Fire']),
  fanFavouriteB(553, 'Krookodile', 77, ['Ground', 'Dark']),
  fanFavouriteB(473, 'Mamoswine', 77, ['Ice', 'Ground']),
  fanFavouriteB(25, 'Pikachu', 76, ['Electric']),
  fanFavouriteB(530, 'Excadrill', 76, ['Ground', 'Steel']),
  fanFavouriteB(169, 'Crobat', 75, ['Poison', 'Flying']),
  fanFavouriteB(229, 'Houndoom', 75, ['Dark', 'Fire']),
  fanFavouriteB(26, 'Raichu', 74, ['Electric']),
  fanFavouriteB(365, 'Walrein', 74, ['Ice', 'Water']),
  fanFavouriteB(407, 'Roserade', 74, ['Grass', 'Poison']),
  fanFavouriteB(478, 'Froslass', 73, ['Ice', 'Ghost']),
  fanFavouriteB(609, 'Chandelure', 73, ['Ghost', 'Fire']),
]

const support = (id, name, score, types) =>
  pokemon({
    id,
    name,
    category: POKEMON_CATEGORIES.SUPPORT,
    draftGroup: 'SUPPORT',
    score,
    types,
    hasTrait: false,
...
export const supportPokemon = [
  support(197, 'Umbreon', 76, ['Dark']),
  support(700, 'Sylveon', 75, ['Fairy']),
  support(196, 'Espeon', 74, ['Psychic']),
  support(134, 'Vaporeon', 73, ['Water']),
  support(135, 'Jolteon', 72, ['Electric']),
  support(470, 'Leafeon', 71, ['Grass']),
  support(471, 'Glaceon', 70, ['Ice']),
  support(136, 'Flareon', 69, ['Fire']),
  support(823, 'Corviknight', 76, ['Flying', 'Steel']),
  support(628, 'Braviary', 74, ['Normal', 'Flying']),
  support(18, 'Pidgeot', 72, ['Normal', 'Flying']),
  support(277, 'Swellow', 71, ['Normal', 'Flying']),
  support(468, 'Togekiss', 76, ['Fairy', 'Flying']),
  support(350, 'Milotic', 75, ['Water']),
  support(242, 'Blissey', 75, ['Normal']),
  support(472, 'Gliscor', 74, ['Ground', 'Flying']),
  support(423, 'Gastrodon', 73, ['Water', 'Ground']),
  support(861, 'Grimmsnarl', 73, ['Dark', 'Fairy']),
  support(462, 'Magnezone', 72, ['Electric', 'Steel']),
  support(477, 'Dusknoir', 70, ['Ghost']),
  support(164, 'Noctowl', 67, ['Normal', 'Flying']),
  support(733, 'Toucannon', 66, ['Normal', 'Flying']),
  support(22, 'Fearow', 65, ['Normal', 'Flying']),
  support(521, 'Unfezant', 64, ['Normal', 'Flying']),
  support(748, 'Toxapex', 67, ['Poison', 'Water']),
  support(598, 'Ferrothorn', 67, ['Grass', 'Steel']),
  support(858, 'Hatterene', 66, ['Psychic', 'Fairy']),
  support(80, 'Slowbro', 66, ['Water', 'Psychic']),
  support(199, 'Slowking', 66, ['Water', 'Psychic']),
  support(579, 'Reuniclus', 65, ['Psychic']),
  support(91, 'Cloyster', 65, ['Water', 'Ice']),
  support(465, 'Tangrowth', 65, ['Grass']),
  support(450, 'Hippowdon', 64, ['Ground']),
  support(591, 'Amoonguss', 64, ['Grass', 'Poison']),
  support(227, 'Skarmory', 64, ['Steel', 'Flying']),
  support(36, 'Clefable', 63, ['Fairy']),
  support(113, 'Chansey', 63, ['Normal']),
  support(10009, 'Rotom-Wash', 63, ['Electric', 'Water']),
  support(630, 'Mandibuzz', 62, ['Dark', 'Flying']),
  support(547, 'Whimsicott', 62, ['Grass', 'Fairy']),
  support(437, 'Bronzong', 62, ['Steel', 'Psychic']),
  support(302, 'Sableye', 61, ['Dark', 'Ghost']),
  support(707, 'Klefki', 61, ['Steel', 'Fairy']),
  support(671, 'Florges', 61, ['Fairy']),
  support(563, 'Cofagrigus', 61, ['Ghost']),
  support(869, 'Alcremie', 60, ['Fairy']),
  support(842, 'Appletun', 60, ['Grass', 'Dragon']),
]
